...
import bussaya.chatsaa.chat.model.Message;
import bussaya.chatsaa.login.MainActivity;
...
//        etMessage.setOnClickListener(onSendM);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == EZPhotoPick.PHOTO_PICK_REQUEST_CODE && resultCode == RESULT_OK) {
            try {
